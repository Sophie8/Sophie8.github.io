...
category: conference
permalink: /publication/2022-10-01-novelty
excerpt: 'This paper proposes Retrieval Augmented Prompt Tuning (RAPT) as a parameter-efficient method to adapt large pre-trained language models for paraphrase generation'
date: 2022
venue: 'AAAI 2022'
paperurl: 'https://arxiv.org/abs/2202.00535'
citation: 'AAAI 2022 Main Track "Novelty Controlled Paraphrase Generation with Retrieval Augmented Conditional Prompt Tuning"'
---
